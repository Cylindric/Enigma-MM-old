...
namespace Plugins
{
    [AddIn("AlphaVespucci Mapper", 
        Version="1.0.0.0",
        Description="AlphaVespucci Mapper",
        Publisher="Mark Hanford")]
    class AlphaVespucci : PluginView, IMapper
    {
        private IServer mServer;
        private string mExePath;
        private string mCachePath;
        private string mOutputPath;
        private int mOptimise;
        private readonly string mTag = "av";

        public override string Name
        {
            get { return "Alpha Vespucci"; }
        }
        ...
        public string CachePath
        {
            set
            {
                mCachePath = Path.Combine(value, mTag);
            }
        }
        ...
        public int OptimisePng { set { mOptimise = value; } }
